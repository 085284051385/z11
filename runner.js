...
number = '6281215567282@s.whatsapp.net'

require('./srv/zero.js')
nocache('./srv/zero.js', module => console.log(`${module} Telah Di Updated... Jangan Lupa Subscribe KingOfBear`))
...
zero.browserDescription = [ 'OCHO STORE', 'Opra', '3.0' ]
console.log(banner.string)
console.log(color('[•] [ CREATED BY OCHO STORE] [•]'))
console.log(color('OCHOO STOREEE'))
console.log(color(' ==============================================='))
console.log(color('│ ○ OCHO STORE     '))
console.log(color('│ ○ OCHO STORE        '))
console.log(color('│ ○ OCHO STORE         '))
console.log(color('│ ○ OCHO STORE                '))
console.log(color(' ==============================================='))
...
zero.sendMessage(anu.jid, "𝐇𝐚𝐲!.. 𝐒𝐚𝐲𝐚 ${namebot} 𝐒𝐚𝐲𝐚 𝐀𝐤𝐚𝐧 𝐌𝐞𝐦𝐛𝐚𝐧𝐭𝐮 𝐌𝐞𝐦𝐛𝐚𝐧𝐭𝐮 𝐌𝐞𝐦𝐩𝐞𝐫𝐦𝐮𝐝𝐚𝐡 𝐊𝐢𝐧𝐞𝐫𝐣𝐚 𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐒𝐞𝐩𝐞𝐫𝐭𝐢 𝐌𝐞𝐦𝐛𝐮𝐚𝐭 𝐒𝐭𝐢𝐜𝐤𝐞𝐫 𝐃𝐚𝐧 𝐋𝐚𝐢𝐧 𝐋𝐚𝐢𝐧.", "conversation")
}
...
sendButImage(anu.jid, teks, `© OCHO STORE`, img,but = [{buttonId:`hallo`, 
...
sendButImage(anu.jid, teks, `© OCHO STORE`, img,but= [{buttonId: `byebye`, buttonText: {displayText: `SELAMAT TINGGAL!!!`}, type: 1}], options = {contextInfo: {mentionedJid: [num, number]}, thumbnail: Buffer.alloc(0)})
}
